  ...
  <View style={styles.container}>
    ...
    <View style={styles.heading}>
      <Text style={{ fontSize: 10, fontWeight: 'bold' }}>
        Formulario Control Salida de Equipos y/o Mobiliarios
      </Text>
    ...
    <View style={styles.metadata}>
      <Text style={{ fontSize: 15, fontWeight: 'extrabold' }}>RC-SAS-003</Text>

      <Text style={{ fontSize: 10, fontWeight: 'bold' }}>FO-SAS-003</Text>
