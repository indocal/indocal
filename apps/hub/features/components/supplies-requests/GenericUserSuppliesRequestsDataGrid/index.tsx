...
export interface GenericUserSuppliesRequestsDataGridProps {
  title: string;
...
export const GenericUserSuppliesRequestsDataGrid: React.FC<
  GenericUserSuppliesRequestsDataGridProps
> = ({
  title,
  requests,
...
export default GenericUserSuppliesRequestsDataGrid;
