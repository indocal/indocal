...
import { FormFieldReport, SignatureFormFieldReport } from '../../../../types';

import { FormEntryEntity } from '../../../../submodules/entries/entities';

export function calcSignatureFormFieldReport(
  ...
  if (record) {
    const content = record.content as SignatureFormFieldReport;
