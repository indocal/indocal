...
import { FormFieldReport, DateTimeFormFieldReport } from '../../types';

import { FormEntryEntity } from '../../submodules/entries/entities';

export function calcDateTimeFormFieldReport(
  ...
  if (record) {
    const content = record.content as DateTimeFormFieldReport;
