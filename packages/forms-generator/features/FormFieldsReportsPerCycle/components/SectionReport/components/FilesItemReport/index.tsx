...
export interface FilesItemReportProps {
  report: SectionFormFieldItemReport;
}

export const FilesItemReport: React.FC<FilesItemReportProps> = ({ report }) => {
  ...
  const options: ChartOptions = useMemo(
    () => ({
      chart: {
        id: FilesItemReport.name + report.item.title,
        toolbar: { show: true },
      },
      title: {
        style: {
...
export default FilesItemReport;
