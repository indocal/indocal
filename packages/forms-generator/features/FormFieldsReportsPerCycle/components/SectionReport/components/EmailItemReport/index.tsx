...
export interface EmailItemReportProps {
  report: SectionFormFieldItemReport;
}

export const EmailItemReport: React.FC<EmailItemReportProps> = ({ report }) => {
  ...
  const options: ChartOptions = useMemo(
    () => ({
      chart: {
        id: EmailItemReport.name + report.item.title,
        toolbar: { show: true },
      },
      title: {
        style: {
...
export default EmailItemReport;
