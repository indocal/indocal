...
export interface RadioItemReportProps {
  report: SectionFormFieldItemReport;
}

export const RadioItemReport: React.FC<RadioItemReportProps> = ({ report }) => {
  ...
  const options: ChartOptions = useMemo(
    () => ({
      chart: {
        id: RadioItemReport.name + report.item.title,
        toolbar: { show: true },
      },
      title: {
        style: {
...
export default RadioItemReport;
