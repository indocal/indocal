...
export interface SelectColumnReportProps {
  report: TableFormFieldColumnReport;
}

export const SelectColumnReport: React.FC<SelectColumnReportProps> = ({
  report,
}) => {
  ...
  const options: ChartOptions = useMemo(
    () => ({
      chart: {
        id: SelectColumnReport.name + report.column.heading,
        toolbar: { show: true },
      },
      title: {
        style: {
...
export default SelectColumnReport;
