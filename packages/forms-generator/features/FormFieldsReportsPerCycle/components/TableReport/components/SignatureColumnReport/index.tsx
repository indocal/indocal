...
export interface SignatureColumnReportProps {
  report: TableFormFieldColumnReport;
}

export const SignatureColumnReport: React.FC<SignatureColumnReportProps> = ({
  report,
}) => {
  ...
  const options: ChartOptions = useMemo(
    () => ({
      chart: {
        id: SignatureColumnReport.name + report.column.heading,
        toolbar: { show: true },
      },
      title: {
        style: {
...
export default SignatureColumnReport;
