...
export interface NumberColumnReportProps {
  report: TableFormFieldColumnReport;
}

export const NumberColumnReport: React.FC<NumberColumnReportProps> = ({
  report,
}) => {
  ...
  const options: ChartOptions = useMemo(
    () => ({
      chart: {
        id: NumberColumnReport.name + report.column.heading,
        toolbar: { show: true },
      },
      title: {
        style: {
...
export default NumberColumnReport;
