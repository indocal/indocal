...
export interface TextAreaColumnReportProps {
  report: TableFormFieldColumnReport;
}

export const TextAreaColumnReport: React.FC<TextAreaColumnReportProps> = ({
  report,
}) => {
  ...
  const options: ChartOptions = useMemo(
    () => ({
      chart: {
        id: TextAreaColumnReport.name + report.column.heading,
        toolbar: { show: true },
      },
      title: {
        style: {
...
export default TextAreaColumnReport;
