...
export interface TimeColumnReportProps {
  report: TableFormFieldColumnReport;
}

export const TimeColumnReport: React.FC<TimeColumnReportProps> = ({
  report,
}) => {
  ...
  const options: ChartOptions = useMemo(
    () => ({
      chart: {
        id: TimeColumnReport.name + report.column.heading,
        toolbar: { show: true },
      },
      title: {
        style: {
...
export default TimeColumnReport;
