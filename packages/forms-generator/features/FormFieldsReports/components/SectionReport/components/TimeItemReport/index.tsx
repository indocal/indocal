...
export interface TimeItemReportProps {
  report: SectionFormFieldItemReport;
}

export const TimeItemReport: React.FC<TimeItemReportProps> = ({ report }) => {
  ...
  const options: ChartOptions = useMemo(
    () => ({
      chart: {
        id: TimeItemReport.name + report.item.title,
        toolbar: { show: true },
      },
      title: {
        style: {
