...
export interface DateItemReportProps {
  report: SectionFormFieldItemReport;
}

export const DateItemReport: React.FC<DateItemReportProps> = ({ report }) => {
  ...
  const options: ChartOptions = useMemo(
    () => ({
      chart: {
        id: DateItemReport.name + report.item.title,
        toolbar: { show: true },
      },
      title: {
        style: {
