...
export interface TextAreaItemReportProps {
  report: SectionFormFieldItemReport;
}

export const TextAreaItemReport: React.FC<TextAreaItemReportProps> = ({
  report,
}) => {
  ...
  const options: ChartOptions = useMemo(
    () => ({
      chart: {
        id: TextAreaItemReport.name + report.item.title,
        toolbar: { show: true },
      },
      title: {
        style: {
...
export default TextAreaItemReport;
