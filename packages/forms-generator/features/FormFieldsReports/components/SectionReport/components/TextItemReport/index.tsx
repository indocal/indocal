...
export interface TextItemReportProps {
  report: SectionFormFieldItemReport;
}

export const TextItemReport: React.FC<TextItemReportProps> = ({ report }) => {
  ...
  const options: ChartOptions = useMemo(
    () => ({
      chart: {
        id: TextItemReport.name + report.item.title,
        toolbar: { show: true },
      },
      title: {
        style: {
