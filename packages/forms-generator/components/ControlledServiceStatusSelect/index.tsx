...
import { ServiceStatus, translateServiceStatus } from '@indocal/services';

export interface ControlledServiceStatusSelect {
  name: string;
  label?: string;
...
export const ControlledServiceStatusSelect: React.FC<
...
export default ControlledServiceStatusSelect;
